  ...
  describe WysiwygMediaController do
    ...
    describe 'GET #index' do
      ...
      describe 'filtering for images' do
        ...
        it { json_response['current_page'].must_equal 1 }
        it { json_response['total_pages'].must_equal 1 }
      end
